...
import com.rohan.lovable.dto.subscription.*;
...
public class BillingController {
    ...
    public ResponseEntity<String> handlePaymentWebhooks(
            ...
            @RequestHeader("Stripe-Signature") String sidHeader
    ){
        try {
            Event event = Webhook.constructEvent(payload, sidHeader,webhookSecret);
